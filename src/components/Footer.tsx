...
export const Footer: React.FC<FooterProps> = ({ onScrollToTop }) => {
  return (
    <footer className="relative bg-[#0d0a08] border-t border-stone-800 pt-12 pb-28 sm:pb-14 text-stone-400 text-xs overflow-hidden select-none">
      ...
      <div className="absolute top-0 right-10 w-72 h-72 bg-[#881337]/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-10 w-72 h-72 bg-[#4c0519]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7 pb-10 border-b border-stone-800/80">
          ...
          <div className="space-y-3.5">
            <div className="flex items-center gap-2.5">
              <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-rose-500/80 p-0.5 bg-rose-900 shrink-0">
                <img
              ...
              <div>
                <h3 className="text-lg font-black text-white">
                  مطعم <span className="text-rose-400">السلطان محمود</span>
                </h3>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5">
              <div className="flex items-center gap-2 text-slate-300 text-xs">
                <div className="p-1.5 rounded-lg bg-white/5 text-rose-400 shrink-0">
              ...
              <div className="flex items-start gap-2 text-slate-400 text-xs">
                <div className="p-1.5 rounded-lg bg-white/5 text-rose-400 shrink-0 mt-0.5">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center justify-between p-2.5 rounded-xl bg-white/5 hover:bg-rose-500/10 border border-white/10 hover:border-rose-500/40 transition-colors group cursor-pointer"
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-stone-300 text-xs font-medium group-hover:text-rose-300">
                    رقم الدليفري 1:
                  </span>
                </div>
                <span dir="ltr" className="text-rose-400 font-mono font-black text-xs sm:text-sm">
                  01097828052
                </span>
              </a>
